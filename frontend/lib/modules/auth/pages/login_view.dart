...
class _LoginViewState extends State<LoginView> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Login realizado com sucesso!'), backgroundColor: Colors.green, behavior: SnackBarBehavior.floating, duration: Duration(seconds: 2)));
        context.go('/');
      }
    } catch (e) {
      if (mounted) {
