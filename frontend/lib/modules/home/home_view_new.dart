  ...
  Widget _buildPayrollHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(colors: [Color(0xFF0F172A), Color(0xFF1E293B), Color(0xFF334155)], begin: Alignment.topLeft, end: Alignment.bottomRight),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(companyName, style: TextStyle(color: Colors.white.withOpacity(0.8), fontSize: 16)),
                const SizedBox(height: 4),
                Text(
                  'Responsável: $userName',
                  style: TextStyle(color: const Color(0xFF22C55E).withOpacity(0.9), fontSize: 14, fontWeight: FontWeight.w500),
                ),
              ],
            ),
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _buildPayrollMetric('Total de Funcionários', '247', 'ativos', const Color(0xFF3B82F6), Icons.people)),
              const SizedBox(width: 16),
              Expanded(child: _buildPayrollMetric('Custo Total', 'R\$ 156.840,00', '+3.2% vs mês anterior', const Color(0xFF059669), Icons.account_balance_wallet)),
              const SizedBox(width: 16),
              Expanded(child: _buildPayrollMetric('Horas Trabalhadas', '45.680h', 'registradas', const Color(0xFF7C3AED), Icons.schedule)),
              const SizedBox(width: 16),
              Expanded(child: _buildPayrollMetric('Pendências', '12', 'requer atenção', const Color(0xFFDC2626), Icons.warning)),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          _buildPayrollAlert('Prazo FGTS vence em 5 dias', 'Vencimento: 07/07/2025', Icons.schedule, const Color(0xFFEA580C), true),
          const SizedBox(height: 12),
          _buildPayrollAlert('12 funcionários com pendências', 'Documentos em falta', Icons.warning, const Color(0xFFDC2626), true),
          const SizedBox(height: 12),
          _buildPayrollAlert('Férias programadas', '8 funcionários em julho', Icons.beach_access, const Color(0xFF3B82F6), false),
          const SizedBox(height: 12),
          _buildPayrollAlert('Backup realizado', 'Última vez: hoje às 06:00', Icons.check_circle, const Color(0xFF059669), false),
          const SizedBox(height: 20),
          Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [const Color(0xFF3B82F6).withOpacity(0.1), const Color(0xFF7C3AED).withOpacity(0.1)]),
            ...
            child: Row(
              children: [
                ...
                TextButton(
                  onPressed: () {},
                  child: const Text('Ver cronograma', style: TextStyle(fontSize: 12)),
                ),
              ],
            ),
          ),
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          height: height,
          decoration: BoxDecoration(
            gradient: LinearGradient(colors: [color, color.withOpacity(0.7)], begin: Alignment.topCenter, end: Alignment.bottomCenter),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [const Color(0xFF059669).withOpacity(0.1), const Color(0xFF22C55E).withOpacity(0.1)]),
              borderRadius: BorderRadius.circular(12),
            ),
            child: Row(
              children: [
                Container(
                  padding: const EdgeInsets.all(8),
                  decoration: BoxDecoration(color: const Color(0xFF059669).withOpacity(0.2), borderRadius: BorderRadius.circular(8)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(color: Color(0xFF059669), fontSize: 14, fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
                ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(' • $department', style: const TextStyle(fontSize: 12, color: Color(0xFF64748B))),
                  ],
                ),
              ],
            ),
